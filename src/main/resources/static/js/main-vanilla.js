...
// 1. Pure block ko ek function ke andar daal diya
function initPipelineChart() {
  withCanvas('pipeline-funnel', (ctx) => {
    
    // Purane chart instance ko destroy karein taaki HTMX swap par canvas crash na ho
    if (window.myPipelineChart instanceof Chart) {
...
// 2. AB IS FUNCTION KO DONO JAGAH TRIGGER KAR DO
initPipelineChart(); // Default normal page refresh ke liye
document.addEventListener('htmx:afterSettle', initPipelineChart); // HTMX sidebar click ke liye
